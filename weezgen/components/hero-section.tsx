...
export function HeroSection() {
  return (
    ...
    >
      {/* SVG Background - keeping the same structure but colors will update via CSS variables */}
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-32 md:mt-[160px] lg:mt-[200px] px-4">
        <h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight">
          AI Sales Agent That Never Sleeps
        </h1>
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Transform your sales process with an intelligent AI chatbot that qualifies leads, answers questions, and
          closes deals 24/7.
        </p>
      </div>
