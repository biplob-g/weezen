...
const faqData = [
  {
    question: "What is SalesBot AI and how does it work?",
    answer:
      "SalesBot AI is an intelligent chatbot designed specifically for sales teams. It uses advanced AI to engage with prospects, qualify leads, answer questions, and guide them through your sales funnel 24/7. The bot learns from your sales conversations and continuously improves its responses.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "SalesBot AI integrates with 50+ platforms including Salesforce, HubSpot, Pipedrive, Slack, WhatsApp, Facebook Messenger, and more. We also provide APIs for custom integrations with your existing sales stack.",
  },
  {
      ...
      <div className="self-stretch pt-8 pb-8 md:pt-14 md:pb-14 flex flex-col justify-center items-center gap-2 relative z-10">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-[18.20px] break-words">
            Everything you need to know about SalesBot AI and how it can transform your sales process
          </p>
        </div>
      </div>
